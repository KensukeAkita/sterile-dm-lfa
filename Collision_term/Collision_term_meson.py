...
def Collision_term_meson(T,i,zeta_nua,zeta_a,zeta_Q,zeta_U,zeta_D):
        ...
        for nj in range(n1): #bin for an integration in the collision term
            ...
            if (T<Tcut-10):
                ...
                for ny in range(n2):
                    ...
                    y = -1 + 2/(n2-1)*(ny-1) #This is cos theta12.
                                    ...
                                    if (B**2-4*A*C>0):
                                        ...
                                        if (Bet<1) and (Bet>-1):
                                            ...
                                            if (Alp<1) and (Alp>-1):
                                                ...
                                                fac = 2*np.pi/(-A)**(1/2)*coe_simps[ny]*2/(n2-1)
    ...
    if (T<Tcut-10):
        ...
        if (flavor == 'e') or (flavor == 'mu'):
            ...
            if (A > 1e-3):
                ...
                Phi = 1/(np.exp(B-A) + 1)*np.log((1+np.exp(-B))/(-A + 1/2*A**2 - 1/6*A**3))
                Phi_bar = 1/(np.exp(B_bar-A_bar) + 1)*np.log((1+np.exp(-B_bar))/(-A_bar + 1/2*A_bar**2 - 1/6*A_bar**3))
            ...
            Coll += 3*xA*Gamma_rho0/((1-xa**2/xA**2)*i**2)*Phi 
            Coll_bar += 3*xA*Gamma_rho0/((1-xa**2/xA**2)*i**2)*Phi_bar 
            ...
            Coll += 3*xA*Gamma_omega/((1-xa**2/xA**2)*i**2)*Phi 
            Coll_bar += 3*xA*Gamma_omega/((1-xa**2/xA**2)*i**2)*Phi_bar 
