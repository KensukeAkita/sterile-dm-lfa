...
from DOF import *
from Collision_term.Collision_term_lepton import Collision_term_lepton
from Collision_term.Collision_term_quark import Collision_term_quark
from Collision_term.Collision_term_meson import Collision_term_meson
...
def Make_Table(La):
    ...
    for ni in range(ni_Table):
        ...
        for nT in range(4):
            ...
            ans =  sp.optimize.root(eqs_redist, x0, args = (T,La), method='hybr',tol=tol_root)  
            ...
            Coll_lepton, Coll_anti_lepton = Collision_term_lepton(T,y,zeta_nue,zeta_numu,zeta_nutau,zeta_e,zeta_mu,zeta_tau) 
            Coll_quark, Coll_anti_quark  = Collision_term_quark(T,y,zeta_nua,zeta_a,zeta_U,zeta_D)
            Coll_meson, Coll_anti_meson  =  Collision_term_meson(T,y,zeta_nua,zeta_a,zeta_Q,zeta_U,zeta_D)
            
            Gamma_a_interp[nT] = (Coll_lepton + Coll_quark + Coll_meson)
            Gamma_a_anti_interp[nT] = (Coll_anti_lepton + Coll_anti_quark + Coll_anti_meson)
        ...
        for nT in range(nT_low):
            ...
            Gamma_a_low[ni,nT] = (Coll_lepton + Coll_quark + Coll_meson)
            Gamma_a_anti_low[ni,nT] = (Coll_anti_lepton + Coll_anti_quark + Coll_anti_meson)
        ...
        for nT in range(nT_high):
            ...
            Gamma_a_high[ni,nT] = (Coll_lepton + Coll_quark + Coll_meson)
            Gamma_a_anti_high[ni,nT] = (Coll_anti_lepton + Coll_anti_quark + Coll_anti_meson)
